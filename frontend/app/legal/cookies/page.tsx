  ...
  return (
    <Box maxW="3xl" mx="auto" py={8} px={4}>
      <VStack align="start" spacing={6}>
        ...
        <Text>Nous utilisons des cookies pour :<br/>- Authentifier les utilisateurs<br/>- Mémoriser vos préférences<br/>- Analyser l’audience<br/>- Améliorer la sécurité</Text>
